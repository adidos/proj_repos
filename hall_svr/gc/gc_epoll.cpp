...
* @param op
*/
void GCEpoll::ctrl(int fd, uint64_t data, uint32_t event, int op)
{
...
* @returns   
*/
int GCEpoll::add(int fd, uint64_t data, uint32_t event)
{
...
* @returns   
*/
int GCEpoll::mod(int fd, uint64_t data, uint32_t event)
{
...
* @returns   
*/
int GCEpoll::del(int fd, uint64_t data, uint32_t event)
{
