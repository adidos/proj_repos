...
public:
	...
	**********************************************************************************/
	...
	// 添加64位整型数据
	virtual bool PutInt64(unsigned short nKeyID, __int64 nData);
	// 添加字节数组的内容
	...
	// 添加Int数组的内容
	virtual bool PutInt64Array(unsigned short nKeyID, __int64* pnData, int nElements);
	...
	// 获取64位整型数据
	virtual bool GetInt64(unsigned short nKeyID, __int64& nData) ;
	...
	virtual bool GetInt64ArrayElement(unsigned short nKeyID, int nIndex, __int64& nData);
...
private:
	...
	vector< vector<__int64> > m_vecInt64ArrayItems;
