...
public:
	...
	***********************************************************************************/
	...
	// 添加64位整型数据
	virtual bool PutInt64(unsigned short nKeyID, int64_t nData) = 0;
	// 添加字节数组的内容
	...
	// 添加Int数组的内容
	virtual bool PutInt64Array(unsigned short nKeyID, int64_t* pnData, int nElements) = 0;
	...
	// 获取64位整型数据
	virtual bool GetInt64(unsigned short nKeyID, int64_t& nData) = 0;
	...
	virtual bool GetInt64ArrayElement(unsigned short nKeyID, int nIndex, int64_t& nData) = 0;
